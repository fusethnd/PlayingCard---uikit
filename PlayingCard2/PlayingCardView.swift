...
//
//    var faceCardScale: CGFloat = SizeRatio.faceCardImageSizeToBoundsSize { didSet { setNeedsLayout() }}
//
...
//    }
    ...
    override func draw(_ rect: CGRect) {
        // use roundedRectangle directly to draw card
